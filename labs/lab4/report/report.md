...
Для однозначной разрешимости уравнения второго порядка ([-@eq:eq:b]) необходимо задать два начальных условия вида
...
Графики, полученные с помощью OpenModelica и Julia идентичны (рис. [@fig:006],  [@fig:007]):
