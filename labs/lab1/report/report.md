...
![Внесение нескольких изменений в содержимое репозитория](image/4_4.png){#fig:004 width=70%}
...
![Просмотр истории](image/5.png){#fig:005 width=70%}
...
![Удаление коммиттов из ветки](image/12.png){#fig:012 width=70%}
...
```
Затем добавим их в репозиторий. Теперь мы хотим добавить в комментарий автора почту, обноим страницу hello, включив в неё почту. Чтобы у нас остался один коммит, а не два, изменим последний с помощью опции --amend, теперь в логах отображается последняя версия коммита(рис. [-@fig:014]).

![Изменение предыдущего коммита](image/14.png){#fig:014 width=70%}
...
![Создание ветки](image/21.png){#fig:021 width=70%}

## Навигация по веткам

Посмотрим все логи(рис. [-@fig:022]).

![Просмотр логов новой ветки](image/22.png){#fig:022 width=70%}

Переключимся обратно на основную ветку и просмотрим содержимое файла lib/hello.html, заметим, что он не использует стили, также просмотрим содержимое этого файла в новой ветке(рис. [-@fig:023]).
...
![Просмотр веток](image/25.png){#fig:025 width=70%}


## Слияние

Слияние переносит изменения из двух веток в одну. Вернемся к ветке style и сольем master со style(рис. [-@fig:026]).

![Слияние веток](image/26.png){#fig:026 width=70%}
...
![Создание конфликта](image/27.png){#fig:027 width=70%}
...
![Поиск коммита перед слиянием](image/29.png){#fig:029 width=70%}

Мы видим, что коммит «Updated index.html» был последним на ветке style перед слиянием. Сбросим ветку style к этому коммиту(рис.  [-@fig:030]).

![Сброс ветки style](image/30.png){#fig:030 width=70%}
...
![Поиск коммита перед конфликтом](image/31.png){#fig:031 width=70%}
...
![Сброс ветки master](image/32.png){#fig:032 width=70%}
...
![Перебазирование](image/33.png){#fig:033 width=70%}

## Слияние в ветку master
 
Вернемся в ветку master и сольем ветку style в неё с помощью команды git merge(рис. [-@fig:034]).

![Слияние style в master](image/34.png){#fig:034 width=70%}
...
![Клонирование репозиториев](image/35.png){#fig:035 width=70%}
...
Сольем внесённые изменения в главную ветку. Также можно было бы использовать команду git pull, которая является объединением fetch и merge в одну команду. (рис. [-@fig:040]).
...
![Добавление ветки наблюдения](image/41.png){#fig:041 width=70%}
...
![Отправка и извлечение изменений](image/43.png){#fig:043 width=70%}
